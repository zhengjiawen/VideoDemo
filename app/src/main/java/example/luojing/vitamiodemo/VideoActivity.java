...
//        path = Environment.getExternalStorageDirectory().getPath()+"[MakariHoshiyume&FZSD][Princess_Principal][01][GB][720P][x264_AAC].mp4";
        Log.d("videoPath", "onCreate: "+path);
    ...
    private void setData() {
        ...
        mTvFilmName.setText(R.string.title);
        String[] paths = path.split("/");
        mTvName.setText(paths[paths.length-1]);
        mTvAnalysis.setText(R.string.content);
        new Thread() {
            @Override
            public void run() {
                //设置缩略图,Vitamio提供的工具类。
    ...
    private void init() {
        ...
        mTvName = (TextView) findViewById(R.id.tv_director);
        mTvAnalysis = (TextView) findViewById(R.id.tv_story);
